...
RSpec.describe PullRequestsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested pull_request as @pull_request" do
      get :show, {:id => pull_request.to_param, repo_id: repo.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested pull_request as @pull_request" do
      get :edit, {:id => pull_request.to_param, repo_id: repo.to_param}, valid_session
      expect(assigns(:pull_request)).to eq(pull_request)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new PullRequest" do
        expect {
          post :create, {:pull_request => valid_attributes, repo_id: repo.to_param}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved pull_request as @pull_request" do
        post :create, {:pull_request => invalid_attributes, repo_id: repo.to_param}, valid_session
        expect(assigns(:pull_request)).to be_a_new(PullRequest)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested pull_request" do
        put :update, {:id => pull_request.to_param, :pull_request => new_attributes, repo_id: repo.to_param}, valid_session
        pull_request.reload
        expect(pull_request.title).to eq 'Fixing all my broken specs'
      end

      it "assigns the requested pull_request as @pull_request" do
        put :update, {:id => pull_request.to_param, :pull_request => valid_attributes, repo_id: repo.to_param}, valid_session
        expect(assigns(:pull_request)).to eq(pull_request)
      end
    ...
    context "with invalid params" do
      it "assigns the pull_request as @pull_request" do
        put :update, {:id => pull_request.to_param, :pull_request => invalid_attributes, repo_id: repo.to_param}, valid_session
        expect(assigns(:pull_request)).to eq(pull_request)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "destroys the requested pull_request" do
      expect {
        delete :destroy, {:id => pull_request.to_param, repo_id: repo.to_param}, valid_session
      }.to change(PullRequest, :count).by(-1)
    end
