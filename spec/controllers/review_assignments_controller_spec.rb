...
RSpec.describe ReviewAssignmentsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested review_assignment as @review_assignment" do
      get :show, {id: review_assignment.to_param, pull_request_id: pull_request.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested review_assignment as @review_assignment" do
      get :edit, {id: review_assignment.to_param, pull_request_id: pull_request.to_param}, valid_session
      expect(assigns(:review_assignment)).to eq(review_assignment)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ReviewAssignment" do
        expect {
          post :create, {:review_assignment => valid_attributes, pull_request_id: pull_request.to_param}, valid_session
        }.to change(ReviewAssignment, :count).by(1)
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved review_assignment as @review_assignment" do
        post :create, {:review_assignment => invalid_attributes, pull_request_id: pull_request.to_param}, valid_session
        expect(assigns(:review_assignment)).to be_a_new(ReviewAssignment)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested review_assignment" do
        put :update, {id: review_assignment.to_param, :review_assignment => new_attributes, pull_request_id: pull_request.to_param}, valid_session
        review_assignment.reload
        expect(review_assignment.team_membership).to eq new_team_membership
      end

      it "assigns the requested review_assignment as @review_assignment" do
        put :update, {id: review_assignment.to_param, :review_assignment => valid_attributes, pull_request_id: pull_request.to_param}, valid_session
        expect(assigns(:review_assignment)).to eq(review_assignment)
      end
    ...
    context "with invalid params" do
      it "assigns the review_assignment as @review_assignment" do
        put :update, {id: review_assignment.to_param, :review_assignment => invalid_attributes, pull_request_id: pull_request.to_param}, valid_session
        expect(assigns(:review_assignment)).to eq(review_assignment)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested review_assignment" do
      review_assignment
      expect {
        delete :destroy, {id: review_assignment.to_param, pull_request_id: pull_request.to_param}, valid_session
      }.to change(ReviewAssignment, :count).by(-1)
    end
