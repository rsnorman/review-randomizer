...
RSpec.describe TeamMembershipsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "redirects to the created team_membership" do
        post :create, {:team_membership => valid_attributes}, valid_session
        expect(response).to redirect_to(TeamMembership.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved team_membership as @team_membership" do
        post :create, {:team_membership => invalid_attributes}, valid_session
        expect(assigns(:team_membership)).to be_a_new(TeamMembership)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested team_membership" do
        team_membership = TeamMembership.create! valid_attributes
        put :update, {:id => team_membership.to_param, :team_membership => new_attributes}, valid_session
      ...
      it "redirects to the team_membership" do
        team_membership = TeamMembership.create! valid_attributes
        put :update, {:id => team_membership.to_param, :team_membership => valid_attributes}, valid_session
        expect(response).to redirect_to(team_membership)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the team_membership as @team_membership" do
        team_membership = TeamMembership.create! valid_attributes
        put :update, {:id => team_membership.to_param, :team_membership => invalid_attributes}, valid_session
        expect(assigns(:team_membership)).to eq(team_membership)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the team_memberships list" do
      team_membership = TeamMembership.create! valid_attributes
      delete :destroy, {:id => team_membership.to_param}, valid_session
      expect(response).to redirect_to(team_memberships_url)
    end
  end
